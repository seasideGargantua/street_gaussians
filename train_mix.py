...
from lib.models.mix_gaussian_renderer import MixGaussianRenderer
...
def training():
    ...
    dataset = Dataset()
    gaussians = MixGaussianModel(dataset.scene_info.metadata)
    ...
    gaussians_renderer = MixGaussianRenderer()
...
def training_report(tb_writer, iteration, scalar_stats, tensor_stats, testing_iterations, scene: Scene, renderer: MixGaussianRenderer):
    if tb_writer:
        try:
